...
import com.telematics.obd.databinding.FragmentObdChooseModelVehicleBinding

class OBDVehicleChooseView @JvmOverloads constructor(
    context: Context,
    ...
    private val binding =
        FragmentObdChooseModelVehicleBinding.inflate(LayoutInflater.from(context), this)
